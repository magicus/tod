...
//		aMaster.flush();
			...
			int aCount)
	{
		...
		IBidiIterator<GridEventNG> theIterator = aDatabase.evaluate(aCondition, theTimestamp);
		return checkCondition(theIterator, aCondition, aReferenceGenerator, aCount);
	}
	
	public static int checkCondition(
			IBidiIterator<GridEventNG> aIterator, 
			EventCondition aCondition,
			EventGenerator aReferenceGenerator,
			int aCount)
	{
		...
		for (int i=0;i<aCount;i++)
		{
			...
			{
				GridEventNG theTestedEvent = aIterator.next(); 
...
//			else System.out.println(i);
			...
			int aCount)
	{
		...
		IBidiIterator<GridEventNG> theIterator = aDatabase.evaluate(aCondition, 0);
