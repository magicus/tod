...
public class TestBufferedIterator
{
	...
	private static class BaseIterator implements BidiIterator<Integer>
	{
		private int itsMin;
		private int itsMax;
	...
	{
		private BidiIterator<Integer> itsBaseIterator;
		
		private int itsBufferSize;
		
		public BufferedIterator(BidiIterator<Integer> aBaseIterator, int aBufferSize)
		{
