...
/**
 * Piped input stream that doesn't assume the writer end
 * is always written to by the same thread.
 */
 ...
 */
public
class PipedInputStream2 extends InputStream {
     ...
     */
    public PipedInputStream2(PipedOutputStream2 src) throws IOException {
	connect(src);
    }
     ...
     * @exception  IOException  if an I/O error occurs.
     */
    public void connect(PipedOutputStream2 src) throws IOException {
	src.connect(this);
    }
