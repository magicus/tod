...
implements RIMultiplexRMIClient
{
	...
	{
		RMISocketFactory.setSocketFactory(MultiplexRMISocketFactory.createClient("client", "localhost", 6789));
		Registry theRegistry = LocateRegistry.getRegistry("server", 90);
